...
var l44BB8553_0 = instance_place(x + 0, y + 0, obj_death);
if ((l44BB8553_0 > 0))
{
	/// @DnDAction : YoYo Games.Common.Variable
	/// @DnDVersion : 1
...
/// @DnDArgument : "x_relative" "1"
/// @DnDArgument : "y_relative" "1"
/// @DnDArgument : "object" "obj_smite"
/// @DnDSaveInfo : "object" "39ec3531-134f-4b67-8b4f-324526b8d44f"
var l1FB5A1DD_0 = instance_place(x + 0, y + 0, obj_smite);
if ((l1FB5A1DD_0 > 0))
{
	/// @DnDAction : YoYo Games.Common.Variable
	/// @DnDVersion : 1
		...
		if(self.y-192<obj_player_alt.y)
		{
			...
			if(self.y+192>obj_player_alt.y)
			{
				...
				if(l462B6EA4_0)
				{
					...
					var l7AF504F9_0 = instance_place(x + 0, y + 0, obj_player_alt);
					if (!(l7AF504F9_0 > 0))
					{
						/// @DnDAction : YoYo Games.Common.If_Expression
						/// @DnDVersion : 1
						...
						if(self.x<obj_player_alt.x)
						{
							...
							if (!(l7E7AB1C7_0 > 0))
							{
								...
								/// @DnDHash : 3A45C618
								/// @DnDParent : 7E7AB1C7
								/// @DnDArgument : "expr" "self.x+4>obj_player_alt.x"
								/// @DnDArgument : "not" "1"
								if(!(self.x+4>obj_player_alt.x))
								{
									/// @DnDAction : YoYo Games.Collisions.If_Object_At
									/// @DnDVersion : 1
									/// @DnDHash : 0DFE9C8C
...
if(bGrowled == false)
{
	...
	if(growl_range == true)
	{
		...
		/// @DnDHash : 4EB071C0
		/// @DnDParent : 751F18AF
		/// @DnDArgument : "soundid" "snd_beast"
		/// @DnDSaveInfo : "soundid" "5ca0efa9-4c3c-4273-a138-1f01757f21c3"
		audio_play_sound(snd_beast, 0, 0);
		...
		/// @DnDHash : 182192E5
		/// @DnDParent : 751F18AF
		/// @DnDArgument : "sound" "snd_beast"
		/// @DnDArgument : "pitch" "random_range(.5,1.5)"
		/// @DnDSaveInfo : "sound" "5ca0efa9-4c3c-4273-a138-1f01757f21c3"
		audio_sound_pitch(snd_beast, random_range(.5,1.5));
	}
}
...
/// @DnDArgument : "value" "3"
with(obj_player_alt) var l6576815C_0 = player_health == 3;
if(l6576815C_0)
{
